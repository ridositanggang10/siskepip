        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Kritik dan Saran Baru</li>
                </ol>
            </section>
            ...
            <section class="content">
                                                            ...
                                                            @foreach ($kds_data as $kds_datas)
                                                                ...
                                                                @foreach ($mas_data as $mas_datas)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="{{ url('/kritik-dan-saran/accept-kds/' . $datas->id) }}"
                                                                        ...
                                                                        <td>    
                                                                            <a href="{{ url('/kritik-dan-saran/reject-kds/' . $datas->id) }}"
                ...
                <div class="d-flex justify-content-center">
                    {!! $kds_data->links('vendor.pagination.custome') !!}
                </div>
        </div><!-- /.row -->
        </section><!-- /.content -->
        </div><!-- /.content-wrapper -->
