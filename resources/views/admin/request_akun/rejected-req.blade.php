            ...
            <section class="content">
              <div class="box box-warning">
                <div class="box-header">
                    <a href="{{ url('/verifikasi/lists')}}" class="btn-sm btn-default" style="margin-left: 20px;"> Daftar Request Akun Baru</a>
                    <a href="{{ url('/verifikasi/acc')}}" class="btn-sm btn-default" style="margin-left: 20px;"> Daftar Request
                      Akun Diterima</a>
                    <a href="{{ url('/verifikasi/reject')}}" class="btn-sm btn-info" style="margin-left: 20px;"> Daftar Request Akun
                      Ditolak</a>
                    <hr>
                  </div>
