                                ...
                                <li>
                                    ...
                                    <div class="mailbox-attachment-info">
                                        <a href="$datas->foto" class="mailbox-attachment-name">
                                            <i class="fa fa-paperclip">{{ $datas->file }}</i>
                                        </a>
                                        <span class="mailbox-attachment-size">
                                            {{ number_format(File::size(public_path('assets_user/standarLayanan/files/' . $datas->file)) / 1048576, 2) . ' MB' }}
                                            <a href="{{ url('/standar-layanan/download-file/'.$datas->file)}}" class="btn btn-default btn-xs pull-right"><i
                                ...
                                <li>
                                    <span class="mailbox-attachment-icon has-img">
                                        <img src="{{ asset('assets_user/standarLayanan/pictures/' . $datas->foto) }}"
                                            alt="Attachment" style="width:198px; height:132px;" class="img-fluid" />
                                    </span>
                                    <div class="mailbox-attachment-info">
                                        ...
                                        <span class="mailbox-attachment-size">
                                            ...
                                            <a href="{{ url('/standar-layanan/download-foto/'.$datas->foto)}}" class="btn btn-default btn-xs pull-right">
